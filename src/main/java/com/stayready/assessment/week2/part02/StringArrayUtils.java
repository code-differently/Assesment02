...
//        int numElementsCopied = arrayToBeSpliced.length - startingIndex;
//        System.arraycopy(arrayToBeSpliced, startingIndex, new String[numElementsCopied], 0, numElementsCopied);
